              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="footer-banner-left">
                    ...
                    <h5 className="text-white mt-3 mb-20">
                      Pending Booked Testing Drive
                    </h5>
                    <h5 className="text-white mt-3 mb-20">
                      1000
                    </h5>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="footer-banner-left">
                    ...
                    <h5 className="text-dark mt-3 mb-20">
                      Approve Booked Testing Drive
                    </h5>
                    <h5 className="text-dark mt-3 mb-20">
                      1000
                    </h5>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="footer-banner-left">
                    ...
                    <h5 className="text-white mt-3 mb-20">Booked Rentals</h5>
                    <h5 className="text-white mt-3 mb-20">
                      1000
                    </h5>
                    <a href="#" className="at-explore-btn text-white">
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="footer-banner-left">
                    <span className="icon-wrapper d-flex align-items-center justify-content-center rounded">
                      <i
                        className="fa-regular fa-calculator text-dark"
                        style={{ fontSize: "27px" }}
                      ></i>
                    </span>
                    <h5 className="text-dark mt-3 mb-20">Tax Calculators</h5>
                    <h5 className="text-dark mt-3 mb-20">
                      1000
                    </h5>
                    <a href="#" className="at-explore-btn text-dark">
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="footer-banner-left">
                    <span className="icon-wrapper d-flex align-items-center justify-content-center rounded">
                      <i
                        className="fa-regular fa-ship"
                        style={{ fontSize: "27px" }}
                      ></i>
                    </span>
                    <h5 className="text-white mt-3 mb-20">Import Orders</h5>
                    <h5 className="text-white mt-3 mb-20">
                      1000
                    </h5>
                    <a href="#" className="at-explore-btn text-white">
