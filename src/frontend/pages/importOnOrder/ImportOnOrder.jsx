...
function ImportOnOrder() {
  ...
  const handleSubmit = async (e) => {
    ...
    const submitData = async () => {
      ...
      try {
        ...
        navigate("/import-on-order_message");
      } catch (error) {
  ...
  return (
    <>
      <SEO
        title="Hassle-Free Car Import to Rwanda | MyOtobox"
        description="MyOtobox simplifies car imports to Rwanda. We source, ship, and clear customs for your dream car from worldwide"
        url="https://www.myotobox.rw/import-on-order"
        image="/assets/images/import-cars-on-order.jpg"
      />
          ...
          <div className="row">
            ...
            >
              <div className="banner-content">
                ...
                <p>
                  We import high-quality vehicles and offer outstanding
                  services. Our commitment to excellence guarantees that you
                  will receive safe, clean, and reliable cars.
                </p>
                <p className="pt-4">
                  <strong>
