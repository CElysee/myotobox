...
function SubmitCar() {
  ...
  const [loginTitle, setLoginTitle] = useState(
    "Sign in to submit an import order"
  );
      ...
      const params = {
       ...
       try {
        const response = await axiosInstance.post(
          "/cars-to-be-sold/create/",
          params
        );
        // console.log(response);
        navigate("/sell-my-car-message");
        setLoading(false);
      } catch (error) {
          ...
          >
            <div className="banner-content">
              ...
              <p className="pt-4">
                ...
                accepted, we’ll ask to see the car in person to verify its
                condition.
              </p>
            </div>
          </div>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="inline_form">
                    <div className="form-inner mb-25">
                      <label>Car Info(Name)</label>
                      <input
                        type="text"
                        placeholder="2023 Toyota RAV4 Prime XSE"
                        name="car_info_name"
                        value={inputValues.car_info_name}
                    ...
                    <div className="form-inner mb-25">
                      ...
                      <input
                        ...
                        value={inputValues.manufacture_year}
                        onChange={handleFormInputs}
                        required
                      ></input>
                    </div>
                  ...
                  <div className="inline_form">
                    ...
                    <div className="form-inner mb-25">
                      ...
                      <input
                        ...
                        placeholder="black"
                        name="interior_color"
                        value={inputValues.interior_color}
                        onChange={handleFormInputs}
                        required
                      ></input>
                    </div>
                  ...
                  <div className="form-inner last">
                    {isAuthenticated ? (
                      <button className="primary-btn1" type="submit" disabled={loading}>
                        {loading ? (
                          <RiseLoader
                            color={color}
                            loading={loading}
                      ...
                      <button
                        ...
                        className="primary-btn1 preload-wrap loaded"
                        type="button"
                        data-toggle="modal"
