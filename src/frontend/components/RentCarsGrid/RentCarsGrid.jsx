              ...
              <li className="auction-item">
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="mt-2-5 w-full border-t pt-2-5 vehicle-card-location">
                        ...
                        >
                          <svg
                            ...
                            height="16"
                            fill="currentColor"
                            className="bi bi-geo-alt-fill vehicle_svg"
                            viewBox="0 0 16 16"
                          >
                        ...
                        >
                          <svg
                            ...
                            height="16"
                            fill="currentColor"
                            className="bi bi-paint-bucket vehicle_svg"
                            viewBox="0 0 16 16"
                          >
                          ...
                          <span>Black exterior, Black interior</span>
                        </div>
                      </div>
                      <div
                        className="vehicle-card-location mt-1 text-xs"
                      ...
                      >
                        <svg
                          ...
                          height="16"
                          fill="currentColor"
                          className="bi bi-car-front-fill vehicle_svg"
                          viewBox="0 0 16 16"
                        >
                        ...
                        <span>No accidents reported, 1 Owner, Fleet use</span>
                      </div>
