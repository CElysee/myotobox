...
function RentalCarGallery() {
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await axiosInstance.get(
          `/car_for_rent/car_details?id=${stock_numner}`
        );
        const lastImage =
  ...
  const imagesArray = galleryImages.map((image) => ({
    ...
    thumbnail: `${imageBaseUrl}/CarRentImages/${image.image_name}`,
    thumbnailWidth: 200,
    thumbnailHeight: 200,
                  ...
                  <div className="col">
                    ...
                    <div className="heading-base flex items-center">
                      <h3>
                        ...
                        {car.car_drive_train}, {car.car_engine_capacity} with {formatAmount(car.car_mileage)} Kilometers
                      </h3>
                    </div>
                  </div>
                </div>
                      ...
                      <div id="gallery-preview-ref" className="draggable">
                        ...
                        <div className="images">
                          <div className="group exterior">
                            ...
                            >
                              <img
                                src={`${imageBaseUrl}/CarRentImages/${lastGalleryImage.image_name}`}
                                alt={`${car.car_year}-${car.car_name_info}`}
                                data-section="exterior"
                                data-id="3pREE80w"
                              />
...
export default RentalCarGallery;
