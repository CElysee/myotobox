                    ...
                    >
                        ...
                        <div className="px-3">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="relative flex-1">
                              ...
                              >
                                {formatAmount(carDetails.car_price_per_day)} Rwf
                                /Day
                              </h2>
                            </div>
                            <button
                      ...
                      >
                        <span className="btn-inner">
                          {isAuthenticated
                            ? "Rent This Car Today!"
                            : "Sign In and Rent This Car Today!"}
                        </span>
                      </button>
                      ...
                      <div className="flex flex-col border-t pt-4 md:mt-4 md:border-t md:pl-2 lg:pl-3">
                        ...
                        <div className="flex">
                          ...
                          <div className="ml-3">
                            ...
                            <div className="mb-3">
                              {carDetails.renter_phone_number}
                            </div>
                          </div>
                        </div>
                        <div className="flex">
...
export default RentalMoreDetails;
